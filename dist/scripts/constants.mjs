export var EXPRESSION_OBJECT = {
    ...
    getGridCountForToken: function(token) {
        ...
        console.log("Single-character token:", DISPLAY_WHAT_SINGLE[token]);
        DISPLAY_WHAT_SINGLE[token].forEach(position => {
            console.log("Position:", position);
            gridSet.add(position);
        });
    
        console.log("Grid Set:", gridSet);
        console.log("Grid Set Size:", gridSet.size);
...
export var DISPLAY_WHAT_SINGLE = {
    ...
    'p' : [10,11,12,13,14,16,18,21,23,26,28,30,33,34],
    '^' : [2,6,8,10,14],
    '!' : [3,4,9,10,11,14,19],
    ...
    'D' : [0,1,2,5,8,10,14,15,19,20,24,25,28,30,31,32],
    ...
    'x' : [2,4,8,12,14],
    'R':  [2,3,4,7,12,17,20,22,26,27,32],
    '^' : [2,6,8,10,14],
};
